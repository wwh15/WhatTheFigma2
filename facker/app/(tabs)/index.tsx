...
import { Image, FlatList, View, TouchableOpacity, Alert, useColorScheme, Modal } from 'react-native';
...
export default function HomeScreen() {
  ...
  const addItemsInGroup = async (newItems: { name: string; expires: string }[]) => {
          ...
          renderItem={({ item, index }) => (
            <View style={styles.itemContainer}>
              <View style={styles.itemTextContainer}>
                <ThemedText type="subtitle" style={{ color: colorScheme === 'dark' ? 'white' : 'black' }}>
                  {item.name}
                </ThemedText>
